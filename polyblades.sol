...
contract PolyBlades is Initializable, AccessControlUpgradeable {
    ...
    function _payContractConverted(address playerAddress, uint256 convertedAmount) internal {
        ...
        sickletoken.safeTransferFrom(playerAddress, address(this), fromUserWallet);
    }
    ...
    function _payPlayerConverted(address playerAddress, uint256 convertedAmount) internal {
        sickletoken.safeTransfer(playerAddress, convertedAmount);
    }
    ...
    function stakeUnclaimedRewards() external {
        ...
        sickletoken.approve(address(stakeFromGameImpl), _tokenRewards);
