    ...
    AccessControlUpgradeable
{
    ...
    // Initializer
    // ############
    function initialize(IERC20 _sickletoken, address _taxRecipient)
        public
        initializer
    {
    ...
    function purchaseListing(
        ...
        sickletoken.safeTransferFrom(msg.sender, taxRecipient, taxAmount);
        sickletoken.safeTransferFrom(
            msg.sender,
            listing.seller,
